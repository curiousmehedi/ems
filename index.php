        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-6 text-center">
                  <div class="x_panel">
                  <div class="x_title">
                    <h2 class="text-center">Punch In</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <a class="btn btn-app btn-primary" href="#"> 
                      <i class="fa fa-play"></i> Punch In
                    </a>
                    <a class="btn btn-app btn-primary" href="#"> 
                      <i class="fa fa-stop"></i> Punch Out
                    </a>
                  </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-6 text-center">
                  ...
                  <div class="x_content pull-left">
                      <a class="btn btn-app">
                        <span class="badge bg-red">18</span>
                        <i class="fa fa-bullhorn"></i> CL
                     </a>
                     <a class="btn btn-app">
                        <span class="badge bg-red">12</span>
                        <i class="fa fa-bullhorn"></i> SL
                     </a>
                  </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-6 text-center">
                  ...
                  <div class="x_content pull-left">
                      <a href="leave_application.php" class="btn btn-app">
                        <i class="fa fa-plus"></i> Apply
                     </a>
                     <a href="leave_application.php" class="btn btn-app">
                        <i class="fa fa-question-circle-o fa-4"></i> View Status
                     </a>
